...
export function StaffManageModal({
  ...
  const blockLabels: BlockLabels = {
    ...
    warnTitle: s["admin.workingHours.prolongadaWarnTitle"],
    warnScope: s["admin.workingHours.prolongadaWarnScope"],
    warnEffect: s["admin.workingHours.prolongadaWarnEffect"],
    warnWrongTool: s["admin.workingHours.prolongadaWarnWrongTool"],
    warnConfirm: s["admin.workingHours.prolongadaConfirm"],
