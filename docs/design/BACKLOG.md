...
| 0027 | multi-therapist booking | DRAFT | 0026 DONE |
| 0028 | batch scheduling engine | DRAFT | 0027 DONE AND availability query DONE |
| TBD | patient ID column | DRAFT | JP patient ID format ruling |

### Ivan non-migration code (parallel-safe, not migration-numbered)
| Item | Status | Gate |
|------|--------|------|
| availability query (read-only, booked vs free) | READY | none, parallel-safe with one in-flight migration |
