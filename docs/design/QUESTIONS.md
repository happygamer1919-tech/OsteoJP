...
### Q-PL-04-1 - NESA "missing": already a seeded service - WHERE is it missing? - REGISTERED for Rodica + CYAN (PL-04, HALTED)
...
### Q-PL-01-1 - Agenda same-hour: vertical stack is intentional + migration 0041 is inert - confirm the fix direction - REGISTERED for owner/Rodica (PL-01, GREEN-defaultable)
...
### Q-PL-02-1 - Patient Marcações "cannot edit": time/estado/cancel already work - does Rodica need a FULL edit (service/therapist)? - REGISTERED for owner/Rodica (PL-02, GREEN-defaultable)
