...
- [x] W2-08 — Polish and debt per SPEC-staff-screens section 9: app-shell ring fix or file removal, hex and spacing sweep with grep proof, anti-goal verification (one banner max, no blank-then-pop, motion budget), pt-PT and en-GB pass on all six screens.
...
- [x] V2-W0-04 HeritageFrame component with surface allowlist and AA inset (after W0-01)
- [x] V2-W0-05 Sidebar AppShell replacing the top bar across apps/web, all seven nav items, Marcações placeholder route, HeritageFrame integration (after W0-02, W0-03, W0-04; hard gate for all section waves)

### V2 section waves (parallel after V2-W0 is green on main)

- [x] V2-W1 Dashboard (Início) per SPEC-v2-dashboard
- [x] V2-W2 Agenda per SPEC-v2-agenda
- [x] V2-W3 Pacientes per SPEC-v2-patients
- [x] V2-W4 Fichas Clínicas per SPEC-v2-fichas
- [x] V2-W5 Revisão per SPEC-v2-review
- [x] V2-W6 Administração per SPEC-v2-admin
- [x] V2-W7 Marcações list view per SPEC-v2-marcacoes (reuses the existing appointments fetch, no new data model)
