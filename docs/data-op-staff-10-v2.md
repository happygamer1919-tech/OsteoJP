...
next to a JP(lv) row that a refusal arm turns into a confirmed overlap; a NESA(cb) row
...
| stage 1 after the write, marker removed | 1 | REFUSE on R08 and R24 | written once |
